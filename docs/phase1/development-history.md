> Historical engineering log through early September 2026. Commands and acceptance statements describe their dated context. For current operation, see [current status](../CURRENT-STATUS.md).
