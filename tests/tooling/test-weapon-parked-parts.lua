...
assert(#meshes==36 and meshes[1]==27 and meshes[32]==58 and meshes[33]==63 and meshes[36]==66,'galvanic round meshes')
...
assert(#Parked.hidden_meshes(receiver,nil,true,60)==32,'clamped to the mesh count')
...
local player={}
api.update(player)
assert(visibility[attachment][27]==false and visibility[attachment][66]==false and visibility[attachment][60]==nil,'rounds hidden')
