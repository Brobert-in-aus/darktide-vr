...
local owns,physical,native_active=false,0
...
print('gameplay_ui_ownership=pass real_adapter overlay_cancel neutral_resume stock_cache scanner retiring_owner')
