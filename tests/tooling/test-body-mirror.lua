...
assert(Mirror.MODES.overlay.collapse_joint=='j_neck' and Mirror.MODES.overlay.scale_to_neck)
assert(Mirror.MODES.overlayhead.collapse_joint=='j_head')
assert(Mirror.MODES.overlayscale.scale_to_neck and not Mirror.MODES.overlayscale.collapse_joint)
assert(Mirror.COLLAPSED_HEAD_SCALE>0,'scale stays invertible')
print('body_mirror=pass keeps_slot same_layout modes hides_slot elbow near_eye hide_gloves neck_offset scale_ratio collapse_joint')
