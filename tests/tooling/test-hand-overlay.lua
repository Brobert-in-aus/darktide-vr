...
local Atlas={new=function(options) assert(options.cell_width==Overlay.CELL and options.log_tag=='DARKTIDEVR_HAND_OVERLAY'); return atlas end}
...
assert(texts[1][1]=='7' and texts[1][2]==30); near(texts[1][3][1],256-Overlay.CELL*.5); near(texts[1][4][2],45)
