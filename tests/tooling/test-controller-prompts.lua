...
scope('ConstantElementOnboardingHandler','_sync_onboarding_settings',function()
    assert(text('hotkey_inventory','View')=='[Unbound]','Unbound hotkey got a false VR or keyboard hint')
end)
bindings.sample(true,0,0,0,true,1,'shooting_range')
scope('ConstantElementOnboardingHandler','_sync_onboarding_settings',function()
    assert(text('hotkey_inventory','View')=='[Unbound]','Hub hint leaked into combat')
end)
