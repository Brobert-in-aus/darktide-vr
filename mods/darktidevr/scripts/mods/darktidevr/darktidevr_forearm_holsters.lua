...
-- Clear of the gun hand glove's gauntlet cuff, which flares about 12 cm above
-- the forearm and runs well back from the wrist (eye renders forearm7-12).
Forearm.ZONE_START = 0.20
