return {
    ...
    -- Titles only: `create_group_template` emits no tooltip, so a group's
    -- description never reaches the player and the title has to carry it
    -- (review, 18 September).
    ...
    vr_full_body_experimental_description = {en = "Show your character's whole body under you: a copy of your character scaled from your calibration, its legs running the game's own animation and its arms solved to your controllers, instead of the tracked hands alone. Takes a few seconds to appear after you turn it on and costs some frames. Its feet follow the animation, not the floor, on slopes and steps."},
    ...
    body_mirror_keybind_description = {en = "In the Psykhanium, stands a mirror of your character a few paces ahead, fixed where you summoned it: its head follows your headset, its fingers match yours and your wielded weapon is in its reflected hand, so you can see what others would. Its legs are not mirrored left for right. Press again to remove it. Default: F8."},
    ...
    vr_weapon_charge_style = {en = "Weapon charge display"},
    vr_weapon_charge_style_count = {en = "Count above the weapon"},
    vr_weapon_charge_style_bars = {en = "The HUD's charge bars above the weapon"},
    vr_weapon_charge_style_off = {en = "Off"},
    ...
    vr_weapon_charge_style_description = {en = "How a melee weapon's special charges (the force sword, the shock maul, the arc weapons) show at the weapon: a count such as 3/5, the HUD's own charge bars, or nothing. The count also needs Ammo count at the hand on. The HUD panel keeps its copy either way."},
    ...
    vr_skull_throw_description = {en = "With the flamethrower servo skull talented, the skull hovers in view at your off-hand side. Grip it with your off hand and it locks to your palm and turns with your hand; mark a target and let go with a throw: it leaves your hand on your own arc, whichever way you threw, then turns for the target. Thrown away from the target, it arrives a moment after the attack begins."},
    ...
    vr_ads_zoom_description = {en = "How much closer the world looks while you aim down the sights, as a percentage. The zoom eases in with the aim and out again; 0 turns it off. It needs Aim focus on. Keep it small: the world gets larger, not sharper."},
